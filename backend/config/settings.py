...
class Settings:
    ...
    RAG_VECTOR_SEARCH_TOP_K: int = 8
    RAG_VECTOR_SEARCH_SIMILARITY_THRESHOLD: float = 0.7
    ...
    RAG_FALLBACK_TO_GENERAL_KNOWLEDGE: bool = True
    RAG_REQUIRE_CONTEXT: bool = False
    RAG_CONTEXT_REQUIRED: bool = False
    RAG_VECTOR_ONLY_MODE: bool = False
    RAG_EXTERNAL_KNOWLEDGE_BLOCKED: bool = False
